...
showIncomingTradeRequest = function()
	-- Cycle a brand new random username from the 100+ list every single time trade starts
...
print("[Hax4You System] Thread loaded safely with randomized global name indexes.")
...
local function getRandomGodlyWeapon()
	local candidates = {}
	if not sync.Weapons then return nil end
...
-- Run initialization on launch and establish auto-reconnect logic upon core player respawns
...
local function ShowNotification(playerName, isReal)
	...
	MainPill.Position = UDim2.new(1, 300, 0, 60)
	MainPill.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
	MainPill.BackgroundTransparency = 0.35

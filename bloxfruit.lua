...
-- ==========================================
-- BLOX FRUITS PURCHASE PROMPT REPLICA
-- ==========================================
local function showBloxFruitsPromptReplica()
    ...
    lastCapturedPromptRoot = os.clock()
    ...
    local headerRobuxIcon = makeText(headerPrice, "Icon", "R$", UDim2.fromOffset(21, 21), UDim2.fromOffset(0, 3), 20, textColor, regularFont)
    ...
    local itemRobuxIcon = makeText(itemCost, "Icon", "R$", UDim2.fromOffset(18, 18), UDim2.fromOffset(0, 2), 17, Color3.fromRGB(238, 240, 244), regularFont)
    ...
    makeText(banner, "BlackbirdIcon", "★", UDim2.fromOffset(22, 22), UDim2.fromOffset(13, 12), 20, textColor, regularFont)
...
-- ==========================================
-- BLOX FRUITS REAL PROMPT DETECTION
-- ==========================================
local function isOurBloxFruitsGui(instance)
    local current = instance
    while current do
        if current.Name == "CartiHubBloxFruitsReplica"
            or current.Name == "BloxFruitsConfigPanel" then
            return true
        end
...
local function pickPromptGiftRecipient(root)
    ...
    -- Fallback: scan for any TextBox that looks like a recipient input
    local bestText = nil
    local bestScore = -math.huge
...
_G.CartiHubReleaseBloxFruitsInputLock = releaseInputLock
_G.CartiHubReleaseBloxFruitsInputLockBurst = releaseInputLockBurst
_G.CartiHubClearBloxFruitsSafeArea = clearFoundationOverlaySafeArea
_G.CartiHubClearBloxFruitsSafeAreaBurst = clearFoundationOverlaySafeAreaBurst
_G.CartiHubPulseBloxFruitsMenuUnlock = pulseRobloxMenuUnlock
...
print("[BloxFruits Standalone] Loaded.")